...
function Hobbies({ database, changeDB }) {
    ...
    console.log(is_run);
    const sql_words = sql_hobbies.query.split(" ");
    const count = 1;

    const worksheetProps = {
        database: database,
        file: sql_hobbies.file,
        changeDB: changeDB,
        run_sql: run_sql
    };
    ...
    return (<>
        ...
        >
            ...
            {isOpen && <DynamicTable data={sql_hobbies.results} />}
