        ...
        <div class='d-flex'>
            <div class="d-flex col-2 mt-1 ms-4 left">
                <div class="btn-group shadow-sm">
                    <button type="button" class="btn btn-primary d-flex align-items-center rounded-end-0 py-1 fw-bold play" onClick={(e) => {
                        const btn = e.currentTarget;

                        btn.focus();  // add focus shadow

                        setTimeout(() => {
                            btn.blur(); // remove it after 1ms
                        }, 2);
