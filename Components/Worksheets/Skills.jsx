...
function Skills({ database, changeDB }) {
    ...
    const [data, setData] = useState(sql_skills.results || []);

    const [is_run, run_sql] = useState(false);
    const [isOpen, setIsOpen] = useState(true);

    const [cols, setCols] = useState(Object.keys(sql_skills.results[0]).reduce((acc, col) => {
    ...
    useEffect(() => {
        ...
        if (searchRow && searchRow.length > 0) {
            ...
            setData(sql_skills.results.filter((row) =>
            ...
            <div className="row mb-1">
                ...
                {isOpen && <div className="col-6 d-flex align-items-center justify-content-end text-secondary">
                    ...
                    >
                        ...
                        {
                            Object.keys(sql_skills.results[0]).map((col) => (
                    ...
                    <CSVLink data={data} filename="Skills_Shagun_Mohta.csv">
                        <button
                            className="btn small"
