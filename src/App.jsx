...
function App() {
 ...
 const [width, setSidebarWidth] = useState("270px");
  ...
  return (
    <>
      ...
      <div className="d-flex landing-page" style={{ height: "100%", width: "100%" }}>
        ...
        <div >
          ...
          <div className="d-flex flex-grow-1 " style={{ background:"white" , marginLeft: "70px", height: "100vh", width: "calc(100vw - 70px)" }}>
            <Sidebar setWidth={width} setSidebarWidth = {setSidebarWidth} />
          


            <div className="flex-grow-1" style={{marginLeft: `${width}`}} >
              <HeaderNav>
              </HeaderNav>

              <Routes>
                <Route path="/" element={<Workspace tab={tab} width={width} />}>
